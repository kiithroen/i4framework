================================================================================
    MFC 라이브러리 : i4mercytool 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 i4mercytool 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 i4mercytool 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
i4mercytool.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CI4MercyToollApp 응용 프로그램
    클래스를 선언합니다.

i4mercytool.cpp
    응용 프로그램 클래스 CI4MercyToollApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\i4mercytool.ico
    ...
    주 리소스 파일인 i4mercytool.rc에 의해 포함됩니다.
...
I4MercyToolDoc.h, I4MercyToolDoc.cpp - 문서
    이 파일에는 CI4MercyToolDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CI4MercyToolDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

I4MercyToolView.h, I4MercyToolView.cpp - 문서 뷰
    이 파일에는 CI4MercyToolView 클래스가 들어 있습니다.
    CI4MercyToolView 개체는 CI4MercyToolDoc 개체를 보는 데 사용됩니다.
...
분할 창
    응용 프로그램 마법사가 응용 프로그램 문서에 분할 창 지원을 추가했습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 i4mercytool.pch와
