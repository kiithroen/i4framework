...
namespace i4core
{
	...
	public:
		...
		void makeInverse(const I4Matrix4x4& mat)
		{
			// 회전 반사 이동으로만 구성된 행렬일때 역행렬은 다음과 같다.
			...
			_32 = mat._23;
			_33 = mat._33;
			_41 = -(_41*_11 + _42*_12 + _43*_13);
			_42 = -(_41*_21 + _42*_22 + _43*_23);
			_43 = -(_41*_31 + _42*_32 + _43*_33);
	...
	inline
	const I4Matrix4x4 operator * (const float& val, const I4Matrix4x4& rhs)
	{
